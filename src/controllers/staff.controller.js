...
const getBranchBookings = async (req, res) => {
  try {
    ...
    return errorResponse(res, error.message || 'Lỗi lấy danh sách booking', [], 500);
  }
};
...
const getBookingDetail = async (req, res) => {
  try {
    ...
    return errorResponse(res, error.message || 'Lỗi lấy chi tiết booking', [], 500);
  }
};
...
const createBooking = async (req, res) => {
  try {
    ...
    if (errors.length) return errorResponse(res, 'Dữ liệu booking không hợp lệ', errors, 400);

    const booking = await staffService.createBooking(req.body);
    return successResponse(res, 'Tạo booking thành công', booking, 201);
  } catch (error) {
    return errorResponse(res, error.message || 'Lỗi tạo booking', error.errors || [], error.status || 500);
  }
};
...
const updateBooking = async (req, res) => {
  try {
    ...
    return errorResponse(res, error.message || 'Lỗi cập nhật booking', error.errors || [], error.status || 500);
  }
};
...
const confirmBooking = async (req, res) => {
  try {
    const bookingId = req.params.id;
    const booking = await staffService.updateBookingStatus(bookingId, 'confirmed');
    if (!booking) return errorResponse(res, 'Booking không tồn tại', [], 404);
    return successResponse(res, 'Xác nhận booking thành công', booking);
  } catch (error) {
    return errorResponse(res, error.message || 'Lỗi xác nhận booking', [], error.status || 500);
  }
};
...
const rejectBooking = async (req, res) => {
  try {
    const bookingId = req.params.id;
    const booking = await staffService.updateBookingStatus(bookingId, 'rejected');
    if (!booking) return errorResponse(res, 'Booking không tồn tại', [], 404);
    return successResponse(res, 'Từ chối booking thành công', booking);
  } catch (error) {
    return errorResponse(res, error.message || 'Lỗi từ chối booking', [], error.status || 500);
  }
};
...
const checkInBooking = async (req, res) => {
  try {
    ...
    return errorResponse(res, error.message || 'Lỗi check-in', [], error.status || 500);
  }
};
...
const checkOutBooking = async (req, res) => {
  try {
    ...
    return errorResponse(res, error.message || 'Lỗi check-out', [], error.status || 500);
  }
};
...
const cancelBooking = async (req, res) => {
  try {
    const bookingId = req.params.id;
    const booking = await staffService.updateBookingStatus(bookingId, 'cancelled');
    if (!booking) return errorResponse(res, 'Booking không tồn tại', [], 404);
    return successResponse(res, 'Hủy booking thành công', booking);
  } catch (error) {
    return errorResponse(res, error.message || 'Lỗi hủy booking', [], error.status || 500);
  }
};
...
const getRooms = async (req, res) => {
  try {
    ...
    return errorResponse(res, error.message || 'Lỗi lấy danh sách phòng', [], 500);
  }
};
...
const updateRoomStatus = async (req, res) => {
  try {
    ...
    return errorResponse(res, error.message || 'Lỗi cập nhật trạng thái phòng', [], 500);
  }
};
...
const updateRoomNote = async (req, res) => {
  try {
    ...
    return errorResponse(res, error.message || 'Lỗi cập nhật ghi chú phòng', [], 500);
  }
};
...
const addService = async (req, res) => {
  try {
    ...
    if (errors.length) return errorResponse(res, 'Dữ liệu dịch vụ không hợp lệ', errors, 400);

    const booking = await staffService.getBookingById(bookingId);
    if (!booking) return errorResponse(res, 'Booking không tồn tại', [], 404);

    const service = await staffService.addBookingService(bookingId, req.body);
    return successResponse(res, 'Ghi nhận dịch vụ phát sinh thành công', service, 201);
  } catch (error) {
...
const getEmptyRoomStats = async (req, res) => {
  try {
    ...
    return errorResponse(res, error.message || 'Lỗi lấy thống kê phòng trống', [], 500);
  }
};
...
const getTodayBookings = async (req, res) => {
  try {
    ...
    return errorResponse(res, error.message || 'Lỗi lấy booking trong ngày', [], 500);
  }
};
...
const getCurrentGuests = async (req, res) => {
  try {
    ...
    return errorResponse(res, error.message || 'Lỗi lấy danh sách khách đang ở', [], 500);
  }
};
